...
if("TRUE" STREQUAL "TRUE")
  set(ball_chaser_SOURCE_PREFIX /media/psf/nd209-robotics/GoChaseIt/catkin_ws/src/ball_chaser)
  set(ball_chaser_DEVEL_PREFIX /media/psf/nd209-robotics/GoChaseIt/catkin_ws/devel)
  ...
  set(ball_chaser_INSTALL_PREFIX /media/psf/nd209-robotics/GoChaseIt/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/psf/nd209-robotics/GoChaseIt/catkin_ws/src/ball_chaser/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/psf/nd209-robotics/GoChaseIt/catkin_ws/devel/lib;/media/psf/nd209-robotics/GoChaseIt/catkin_ws/devel/lib;/opt/ros/noetic/lib)
